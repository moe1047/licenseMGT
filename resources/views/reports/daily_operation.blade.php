                ...
                <div class="box-body ">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            <label>From</label>
                            <input type="date" name="from" value="{{\Carbon\Carbon::today()->toDateString()}}" class="form-control">
                        </div>
                        <div class="form-group col-md-3">
                            <label>To</label>
                            <input type="date" name="to" value="{{\Carbon\Carbon::today()->toDateString()}}" class="form-control">
                        </div>
                        <!-- select2 -->
                        <div class="form-group col-md-3">
                            <label>Town</label>
                    ...
                    <table class="table table-bordered">
                        ...
                        @if(isset($operations))
                            ...
                            @foreach($operations as $operation)
                                <? $total_fish_1+=$operation->amount_fish_1;?>
                                <tr>
