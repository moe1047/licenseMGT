        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/license') }}"><i class="fa fa-file-text-o"></i> <span>Licenses</span></a></li>
              <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/renewal') }}"><i class="fa fa-bug"></i> <span>Renewals</span></a></li>
              <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/dailyOperation') }}"><i class="fa fa-anchor"></i> <span>Daily Operations</span></a></li>
